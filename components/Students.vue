        ...
        <div class="flex justify-end gap-5">
              ...
              <v-card-text>
                <div class="">
                  ...
                  <div class="flex justify-end w-full">
                    <v-btn color="primary" dark @click="createStudent"
                      >Ekle</v-btn
                    >
                  </div>
                </div>
          ...
          <div v-if="selected">
            <v-dialog v-model="editStudentDialog" width="750">
              ...
              <v-card>
                <v-card-title>
                  <span class="text-h5">Öğrenci Düzenle</span>
                </v-card-title>
                ...
                <v-card-text>
                  <div class="">
                    ...
                    ></v-select>
                    <div class="flex justify-end w-full">
                      <v-btn color="primary" dark @click="updateStudent"
                        >Güncelle</v-btn
                      >
                    </div>
                  </div>
            ...
            <v-btn dark small @click="snackbarDelete = true"
              >Öğrenciyi Sil</v-btn
            >
